...
<%@ include file="_header.jsp" %>
    ...
    <div class="card">
        ...
        <div class="filtro-categorias">
            <a href="${pageContext.request.contextPath}/catalogo" class="chip chip-activo">Todos</a>
            <a href="${pageContext.request.contextPath}/catalogo?categoria=abarrotes" class="chip">Abarrotes</a>
            <a href="${pageContext.request.contextPath}/catalogo?categoria=lacteos" class="chip">Lacteos</a>
            <a href="${pageContext.request.contextPath}/catalogo?categoria=limpieza" class="chip">Limpieza</a>
            <a href="${pageContext.request.contextPath}/catalogo?categoria=bebidas" class="chip">Bebidas</a>
        </div>
